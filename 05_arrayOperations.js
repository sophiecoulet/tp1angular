...
const filterNameStartByA = (array) => array.filter(item => item.toLowerCase().startsWith("a"));
console.log(filterNameStartByA(["Arthur","Igor","Sophie","Anais"]));
